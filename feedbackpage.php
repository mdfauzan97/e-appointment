...
<div class="container">
  ...
  <div class="section-title">
    ...
    <p>Please fill in your feedback regarding the system or the hospital.</p>
  </div>
  <div class="row">
    <div class="try">
      <form method="POST" action="tryreg2.php">
        ...
        <div class="col-md-4 form-group mt-3 mt-md-0">
          ...
          <input type="int" id="phonenum" name="phonenum" placeholder="Eg. 6012345678"> <br><br>
        </div>
        <div class="col-md-4 form-group mt-3 mt-md-0">
          <label for="email">E-mail</label> 
          <input type="text" id="email" name="email" placeholder="E-mail.."> <br><br>
        </div>
        <label for="Tujuan">Feedback</label><br>
        <textarea id="Tujuan" name="Tujuan" placeholder="Write or list your feedback.." style="height:170px"></textarea> <br>
